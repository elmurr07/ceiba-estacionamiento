...
public class VehiculoTest {
	...
	public void guardarVehiculo() {
		...
		VehiculoDto vehiculoDto = VehiculoTestBuilder.defaultValues().conPlaca(PLACA_VEHICULO)
				.conTipo(VehiculoDominio.TIPO_VEHICULO_CARRO).conCilindraje(CILINDRAJE_VEHICULO).buildDto();
		...
		Assert.assertEquals(VehiculoDominio.TIPO_VEHICULO_CARRO, vehiculo.getTipo());
